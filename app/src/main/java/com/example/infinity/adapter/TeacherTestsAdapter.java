...
public class TeacherTestsAdapter extends FirestoreRecyclerAdapter<Test, TeacherTestsAdapter.TeacherTestViewHolder> {

    Context context;
    public TeacherTestsAdapter(@NonNull FirestoreRecyclerOptions<Test> options,Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull TeacherTestViewHolder holder, int position, @NonNull Test test) {
